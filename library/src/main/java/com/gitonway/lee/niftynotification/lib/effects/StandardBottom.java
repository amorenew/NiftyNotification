...
public class StandardBottom extends BaseEffect {
    @Override
    protected void setInAnimation(View view) {
        getAnimatorSet().playTogether(
                ObjectAnimator.ofFloat(view, "translationY",
                        view.getRootView().getHeight() * .9f,
                        view.getRootView().getHeight() * .8f)
    ...
    protected void setOutAnimation(View view) {
        getAnimatorSet().playTogether(
                ObjectAnimator.ofFloat(view, "translationY", view.getRootView().getHeight() * .8f,
                        view.getRootView().getHeight()).setDuration(mDuration)
